...
import { Eye, Mail, Phone, Calendar, CheckCircle, Clock, Search, Filter } from 'lucide-react';
...
export default function ContactTable({ contacts, onUpdateStatus, onViewDetails }) {
